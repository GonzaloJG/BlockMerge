...
// Version     :Proyecto con ampliaciones
...
void pruebatadTablero(){
	//pruebaIniciarTablero();
	//pruebainiciarConMatriz();
	//pruebaObtenerTamanoTablero();
	//pruebaSonCoordenadasValidas();
	//pruebaPonerValorTablero();
	//pruebaVaciarCasillaTablero();
	//pruebaHayBloque();
	//pruebaHayBloqueTablero();
	//pruebaValorMaximo();
	//pruebaVaciarBloque();
	//pruebaBajarColumna();
	//pruebaBajarColumnaTablero();
	//pruebaAleatorioColumna();
	//pruebaAleatorioTablero();
}
